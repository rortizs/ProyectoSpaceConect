...
<div class="panel panel-default panel-providers">
    ...
    <div class="panel-body border-panel">
        <div class="row">
            ...
            <div id="list-btns-exportable" style="display: none;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-white" data-toggle="tooltip" data-original-title="Importar proveedores" onclick="modal_import();"><i class="fas fa-upload"></i></button>
              </div>
              <?php } ?>
              <div class="btn-group">
                <button type="button" class="btn btn-white" data-toggle="tooltip" data-original-title="Exportar proveedores" onclick="exports();"><i class="far fa-file-excel f-s-14"></i></button>
              </div>
              <?php } ?>
            </div>

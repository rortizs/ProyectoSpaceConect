        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" id="idprofile" name="idprofile" value="">
                        <div class="col-md-12 form-group">
                            <label for="profile" class="control-label">Nombre de perfil <span class="text-danger">*</span></label>
                            <input type="text" class="form-control text-uppercase" name="profile" id="profile" placeholder="INGRESE PERFIL" data-parsley-required="true">
                        </div>
                        <div class="col-md-12 form-group">

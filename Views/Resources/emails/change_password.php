    						            ...
    						            <tr>
    							            <td style="vertical-align: top;padding: 25px;">
                    							<table cellpadding="0" cellspacing="0" width="100%">
                    								<tbody>
                    									<tr>
                    										<td style="vertical-align: top;padding: 0px;">Tu contraseña ha sido restablecida.</td>
                    									</tr>
                                                        <br>
														<tr>
															<td style="vertical-align: top;padding: 0px;text-justify">
                                                                Si no solicitó este restablecimiento, <a href="https://mail.google.com/mail/u/0/#inbox/FMfcgzGqQJnxMXdQVjJnqHXpbczGlHQW?compose=new">contáctenos</a>.
															</td>
														</tr>
                                                        <br>
                                                        <tr>

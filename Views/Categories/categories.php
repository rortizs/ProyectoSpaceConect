...
<div class="panel panel-default panel-categories">
    ...
    <div class="panel-body border-panel">
        ...
        <div id="list-btns-exportable" style="display: none;">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-white" data-toggle="tooltip" data-original-title="Importar categorias" onclick="modal_import();"><i class="fas fa-upload"></i></button>
              </div>
              <?php } ?>
              <?php } ?>
            </div>

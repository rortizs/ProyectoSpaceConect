...
class Apemisor extends Controllers {
  ...
  public function apemisor() {
    if(empty($_SESSION['permits_module']['v'])){
      header("Location:".base_url().'/dashboard');
    }
    $data['columns'] = $this->model->listMetaData();
    $data['page_name'] = "AP Emisor";
    $data['page_title'] = "AP Emisor";
    $data['home_page'] = "Dashboard";
    $data['previous_page'] = "Gestión de Red";
    $data['actual_page'] = "AP Emisor";
    $data['page_functions_js'] = "ap_emisor.js";
    $this->views->getView($this, "apemisor", $data);
  }
